...
Results of the questionnaire in a structured format (Type: Dictionary/JSON) 
...
<u>What outputs it provides:</u> 
Matches and information about them in a structured format (Type: List of Dictionaries) 
...
<u>What input it requires:</u> 
Product information from the user in a structured format (Type: Dictionary)
